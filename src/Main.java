...
public class Main {
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        int resultadoMenu = objetoConversion.mostrarMenu();
        if(resultadoMenu == 0){
            System.out.println(" Menu Finaliza Exitosamente: "+resultadoMenu);
        }else{
            System.out.println("Menu Finaliza Con Excepción: "+resultadoMenu);
        }
